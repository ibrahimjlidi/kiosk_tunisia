...
export const getAllStations = async (_req: Request, res: Response): Promise<void> => {
  try {
    ...
    res.status(500).json({ success: false, message: error.message || 'Error fetching stations' });
  }
};
...
export const createStation = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    res.status(400).json({ success: false, message: error.message || 'Error creating station' });
  }
};
...
export const updateStation = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    res.status(400).json({ success: false, message: error.message || 'Error updating station' });
  }
};
...
export const deleteStation = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    res.status(500).json({ success: false, message: error.message || 'Error deleting station' });
  }
};
